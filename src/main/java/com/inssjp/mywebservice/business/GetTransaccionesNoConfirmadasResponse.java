...
/**
 * <p>Clase Java para getTransaccionesNoConfirmadasResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getTransaccionesNoConfirmadasResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getTransaccionesNoConfirmadasResponse", propOrder = {
    "_return"
})
public class GetTransaccionesNoConfirmadasResponse {
