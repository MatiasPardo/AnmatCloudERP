...
/**
 * <p>Clase Java para transaccionesNoConfirmadasWSResult complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="transaccionesNoConfirmadasWSResult"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="list" type="{http://business.mywebservice.inssjp.com/}transaccionPlainWS" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "transaccionesNoConfirmadasWSResult", propOrder = {
    "cantPaginas",
    "errores",
    "hayError",
    "list"
})
public class TransaccionesNoConfirmadasWSResult {
    ...
    @XmlElement(nillable = true)
    protected List<TransaccionPlainWS> list;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TransaccionPlainWS }
     * 
     * 
     */
    public List<TransaccionPlainWS> getList() {
        if (list == null) {
            list = new ArrayList<TransaccionPlainWS>();
        }
        return this.list;
    }
