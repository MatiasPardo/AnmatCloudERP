...
/**
 * <p>Clase Java para sendMedicamentosFraccionResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="sendMedicamentosFraccionResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "sendMedicamentosFraccionResponse", propOrder = {
    "_return"
})
public class SendMedicamentosFraccionResponse {
