 ...
 *       &lt;sequence&gt;
 *         &lt;element name="return" type="{http://business.mywebservice.inssjp.com/}catalogoGLNResult" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetCatalogoElectronicoByGLNResponse {
    ...
    protected CatalogoGLNResult _return;
     ...
     * @return
     *     possible object is
     *     {@link CatalogoGLNResult }
     *     
     */
    public CatalogoGLNResult getReturn() {
        return _return;
    }
     ...
     *     
     */
    public void setReturn(CatalogoGLNResult value) {
        this._return = value;
    }
