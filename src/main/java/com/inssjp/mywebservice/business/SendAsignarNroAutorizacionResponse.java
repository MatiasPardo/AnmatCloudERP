...
/**
 * <p>Clase Java para sendAsignarNroAutorizacionResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="sendAsignarNroAutorizacionResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "sendAsignarNroAutorizacionResponse", propOrder = {
    "_return"
})
public class SendAsignarNroAutorizacionResponse {
