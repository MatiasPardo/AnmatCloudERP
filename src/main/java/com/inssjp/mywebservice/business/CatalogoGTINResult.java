...
/**
 * <p>Clase Java para catalogoGTINResult complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="catalogoGTINResult"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="list" type="{http://business.mywebservice.inssjp.com/}medicamentoPlain" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "catalogoGTINResult", propOrder = {
    "cantPaginas",
    "errores",
    "hayError",
    "list"
})
public class CatalogoGTINResult
    extends ResultadoPersonalizado
{
    ...
    @XmlElement(nillable = true)
    protected List<MedicamentoPlain> list;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link MedicamentoPlain }
     * 
     * 
     */
    public List<MedicamentoPlain> getList() {
        if (list == null) {
            list = new ArrayList<MedicamentoPlain>();
        }
        return this.list;
    }
